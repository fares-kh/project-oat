...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'The Nutty One',
    price: 5.95,
    description: "Peanut flavoured oats soaked in oat milk, Greek yoghurt & chia seeds. Topped with a yoghurt layer, crushed peanuts and a dark chocolate roof.",
    image: '/monthly-special-september.png',
    isSignature: true,
    availableFrom: '2026-09-01',
    availableUntil: '2026-09-30',
    ingredients: 'Greek yoghurt (33%) (0% Fat natural Greek yogurt (MILK)), Soft cheese (22%) (Reduced Fat Soft Cheese (MILK), Salt, Stabilisers: Guar Gum, Carrageenan; Citrus Fibre), OAT milk (16%) (OAT base (water, OATS), rapeseed oil, calcium carbonate, acidity regulator (dipotassium phosphate), salt, vitamins (B2, D, B12), potassium iodide), OATS (11%), Dark chocolate (6%) (Cocoa Mass, Sugar, Cocoa Butter, Anhydrous MILK Fat, Emulsifiers (Lecithins), Flavouring), PEANUT butter (3%) (PEANUTS), PEANUTS (3%), Honey, Chia [salvia hispanica] seeds, Coconut oil & Vanilla extract (invert sugar syrup, vanilla extract, water, partially inverted sugar syrup). May contain: sesame seeds & tree nuts. Made in a kitchen that also handles, eggs, fish, lupin, sesame, soya, sulphur dioxide/sulphites and tree nuts.',
    nutrition: { energy_kcal: 487, energy_kj: 2037, fat_g: 17, saturates_g: 6, carbs_g: 46, sugars_g: 17, fibre_g: 8, protein_g: 27, salt_g: 0.78 },
  },
  {
    id: 'monthly-special-october',
    name: 'Eton Mess',
    price: 5.95,
    description: "Oats soaked in low-fat Greek yoghurt, strawberries, white chocolate flavouring & low-fat soft cheese. Topped with a meringue crumble.",
    image: '/monthly-special-october.png',
    isSignature: true,
    monthlySpecial: true,
    availableFrom: '2026-10-01',
    availableUntil: '2026-10-31',
    ingredients: 'Reduced fat soft cheese (26%) (MILK, Salt, Stabilisers: Guar Gum, Carrageenan; Citrus Fibre.), strawberries (22%), Greek yoghurt (18%) (MILK), OAT milk (13%) (water, OATS, rapeseed oil, calcium carbonate, acidity regulator (dipotassium phosphate), salt, vitamins (B2, D, B12), potassium iodide), OATS (12%), meringue (4%) (Sugar, Pasteurised Free Range EGG White), honey (3%), vanilla extract (invert sugar syrup, vanilla extract, water, partially inverted sugar syrup), flavouring (Water, Sweetener (Sucralose), Flavouring, Colour (Plain Caramel)). Made in a kitchen that also handles: gluten, eggs, fish, lupin, milk, peanuts, sesame, soya, sulphur dioxide/sulphites, and tree nuts.',
    nutrition: { energy_kcal: 450, energy_kj: 1883, fat_g: 15, saturates_g: 8, carbs_g: 54, sugars_g: 26, fibre_g: 6, protein_g: 23, salt_g: 0.94 },
  },
  {
    id: 'sticky-mango',
    name: 'Sticky Mango',
    price: 5.95,
    description: "Mango & coconut soaked oats mixed with chia seeds. Topped with coconut yoghurt, mango pieces & sesame seeds.",
    image: '/sticky-mango.png',
